...
def send_image(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/cups-01.jpg', 'rb'))
...
def the_fool(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-00.jpg', 'rb'))
...
def the_magician(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-01.jpg', 'rb'))
...
def the_high_priestess(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-02.jpg', 'rb'))
...
def the_empress(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-03.jpg', 'rb'))
...
def the_emperor(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-04.jpg', 'rb'))
...
def the_hierophant(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-05.jpg', 'rb'))
...
def the_lovers(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-06.jpg', 'rb'))
...
def the_chariot(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-07.jpg', 'rb'))
...
def strength(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-08.jpg', 'rb'))
...
def the_hermit(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-09.jpg', 'rb'))
...
def wheel_of_fortune(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-10.jpg', 'rb'))
...
def justice(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-11.jpg', 'rb'))
...
def the_hanged_man(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-12.jpg', 'rb'))
...
def death(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-13.jpg', 'rb'))
...
def temperance(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-14.jpg', 'rb'))
...
def devil(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-15.jpg', 'rb'))
...
def tower(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-16.jpg', 'rb'))
...
def the_star(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-17.jpg', 'rb'))
...
def the_moon(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-18.jpg', 'rb'))
...
def the_sun(update, context):
    context.bot.send_photo(chat_id=update.effective_chat.id, photo=open('src/mystictarot/major-19.jpg', 'rb'))
